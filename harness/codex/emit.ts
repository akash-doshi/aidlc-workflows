...
# Enables MCP-app (MCP-UI) rendering, required for the aidlc-dashboard panel to
# show in the Codex app. Experimental flag; harmless if the dashboard is unused.
apps = true
